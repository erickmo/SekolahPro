...
| # | ADR | Judul | Paralel? |
|---|-----|-------|----------|
| 1 | `[C] ADR-001` | Go Clean Architecture + CQRS ★ | Ya |
| 2 | `[C] ADR-002` | Vernon Denormalized Read-Cache ★ | Ya |
| 3 | `[C] ADR-003` | Hybrid CQRS + Vernon Decision Criteria ★ | Ya |
| 4 | `[C] ADR-005` | Event Bus (InMemory / NATS JetStream) ★ | Ya |
| 5 | `[C] ADR-006` | Uber FX Dependency Injection ★ | Ya |
| 6 | `[C] ADR-007` | UUID v7 Primary Key ★ | Ya |
| 7 | `[C] ADR-008` | React 18 + Vite + CSS Modules | Ya |
| 8 | `[C] ADR-009` | Dual-Mode Institution Type (General / Islamic) ★ | Ya |
...
> Fitur pertumbuhan — asuransi, mobile app, pendidikan anggota.
...
| # | ADR | Judul | Kapan |
|---|-----|-------|-------|
| — | `[C] ADR-014` | Vernon Sync Engine Strategy | Sprint 0-2 |
| — | `[C] ADR-015` | Frontend Architecture Multi-App | Sprint 0-1 |
| — | `[C] ADR-016` | Deployment & CI/CD Pipeline | Sprint 0 |
| — | `[C] ADR-017` | Data Migration & Import Strategy | Sprint 8+ |
| — | `[C] ADR-018` | Regulatory Compliance | Ongoing |
| — | `[C] ADR-BIZ-001` | Business Model & Pricing | Pre-Sprint 0 |
...
| Sprint | Fase | ADR Count | Focus |
|--------|------|-----------|-------|
| 0 | Fase 0 + INF | 8 + 3 | Platform foundation, CI/CD, boilerplate |
| 1 | Fase 1 | 2 | Auth, multi-tenant, RBAC |
| 2 | Fase 2 + 3 | 3 + 3 = 6 | Master data sekolah + core koperasi |
| 3 | Fase 4A + 4B | 7 + 3 = 10 | Student core + simpanan koperasi |
| 4 | Fase 5A + 5B | 6 + 4 = 10 | Kurikulum + pembiayaan koperasi |
| 5 | Fase 6A + 6B | 8 + 4 = 12 | Kehadiran, nilai + transaksi koperasi |
| 6 | Fase 7A + 7B + 15 | 7 + 4 + 5 = 16 | Rapor, HR guru + akuntansi + governance/compliance |
| 7 | Fase 8 + 15 cont. | 7 | Fasilitas, sarana, PKG, payroll |
| 8 | Fase 9 + 10 + 16 | 5 + 3 + 5 = 13 | Asrama, kantin + ext. koperasi + operational excellence |
| 9 | Fase 11 + 16 cont. | 7 | Portal, notifikasi, dashboard |
| 10 | Fase 12 + 17 | 6 + 3 = 9 | Administrasi, keuangan + insurance, mobile, education |
| 11 | Fase 13 | 5 | Integrasi, reporting, analytics |
| 12+ | Fase 14 + 18 | 3 + 3 = 6 | Alumni, beasiswa, event + dissolution, consolidation, roadmap |
| — | Fase INF | 6 | Infrastructure (ongoing) |
| **Total** | | **116** | **Core: 18 · Sekolah: 58 · Koperasi: 40** |

---

*Generated: 2026-04-15 — Berdasarkan dependency analysis dari semua ADR.*
*Updated: 2026-04-15 — Added K025-K040 (governance, compliance, operational excellence, strategic).*
